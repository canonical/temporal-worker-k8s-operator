...
class TemporalWorkerConsumerProvider(framework.Object):
    ...
    def __init__(self, charm: CharmBase):
        ...
        charm.framework.observe(charm.on[RELATION_NAME].relation_joined, self._on_worker_consumer_changed)
        charm.framework.observe(charm.on[RELATION_NAME].relation_changed, self._on_worker_consumer_changed)
...
class TemporalWorkerConsumerRelationReadyEvent(EventBase):
    ...
    def __init__(
        ...
        """Initialize worker-consumer ready event.
    ...
    def snapshot(self) -> dict[str, str]:
        ...
        Returns:
            Dictionary containing namespace and queue.
        """
    ...
    def restore(self, snapshot: dict[str, str]) -> None:
        ...
        Args:
            snapshot: Snapshot dictionary containing namespace and queue.
        """
...
class TemporalWorkerConsumerRequirerCharmEvents(ObjectEvents):
    ...
    Attributes:
        temporal_worker_consumer_available: Emitted when provider data is available.
    """
...
class TemporalWorkerConsumerRequirer(framework.Object):
    ...
    Attributes:
        on: Event namespace for requirer relation events.
        relations: Active relations for this interface.
        namespace: Namespace value from relation data.
        queue: Queue value from relation data.
    """
    ...
    def __init__(self, charm: CharmBase):
        ...
        self.charm = charm
        charm.framework.observe(charm.on[RELATION_NAME].relation_joined, self._on_worker_consumer_relation_changed)
        charm.framework.observe(charm.on[RELATION_NAME].relation_changed, self._on_worker_consumer_relation_changed)
